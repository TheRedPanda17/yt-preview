class AdminUser < ApplicationRecord
  ...
  def avatar_url
    if profile_picture.attached?
      Rails.application.routes.url_helpers.media_path(profile_picture.blob.signed_id)
  ...
  def channel_banner_image_url
    if channel_banner.attached?
      Rails.application.routes.url_helpers.media_path(channel_banner.blob.signed_id)
